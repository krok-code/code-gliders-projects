import{l as g,i as u,g as w}from"./assets/footer-b144e955.js";import{a as m,P as z}from"./assets/vendor-58a52777.js";function x(t){const s=[...t,"Show all"].map(o=>`<li class="filters-categories-item" data-category="${o}">${o}</li>`);document.querySelector(".filters-categories-list").insertAdjacentHTML("beforeend",s.join("").replaceAll("_"," ")),console.log("Rendered Category List:",s)}function E(t){const e=this.closest(".filters-wrap"),s=e.querySelector(".filters-down-svg");e.querySelector("ul").classList.toggle("list-active"),s.classList.toggle("rotate")}function H(t){this.classList.toggle("rotate");const e=this.previousElementSibling;e.classList.contains("list-active")?e.classList.remove("list-active"):e.classList.add("list-active")}function T(){const t=document.querySelector(".filters-search-btn");t&&t.click()}function _(t){const e=document.querySelector(".filters-categories"),s=document.querySelector(".filters-categories-list"),a=t.target.textContent;e.textContent=a,s.classList.remove("list-active"),s.nextElementSibling.classList.remove("rotate"),T()}function F(t){const e=document.querySelector(".filters-allTypes"),s=document.querySelector(".filters-allTypes-list"),a=t.target.textContent;e.textContent=a,s.classList.remove("list-active"),s.nextElementSibling.classList.remove("rotate"),T()}function P(){const t=document.querySelector(".filters-allTypes").textContent.split(" ").join(""),s=document.querySelector(".filters-categories").textContent.trim(),a=s.toLowerCase()==="all"?"":s.split(" ").join("_").replace("/","&"),o=document.querySelector(".filters-input").value,c={category:a,keyword:o,filterSearch:`by${t}`},r=g.load("queryParams");if(r&&r.category===c.category&&r.keyword===c.keyword&&r.filterSearch===c.filterSearch)return null;const n={category:a,keyword:o,filterSearch:`by${t}`,page:1,limit:9};return g.save("queryParams",n),c}function A(t){let e;switch(t){case"byAtoZ":e="byABC=true";break;case"byZtoA":e="byABC=false";break;case"byCheaperfirst":e="byPrice=true";break;case"byExpensivefirst":e="byPrice=false";break;case"byPopular":e="byPopularity=false";break;case"byNotpopular":e="byPopularity=true";break;case"Show all":e="";break;default:e="byABC=true";break}return e}const B="https://food-boutique.b.goit.study/api/products";async function O(){return(await m.get("https://food-boutique.b.goit.study/api/products/categories")).data}async function R(t){let{keyword:e,category:s,page:a,limit:o,filterSearch:c}=t;const r=window.innerWidth;r<768?o=6:r>=768&&r<1440?o=8:o=9;const n=new URLSearchParams({page:a,limit:o});return e!==""&&n.append("keyword",e),s!==""&&s!=="Show_all"&&s!=="Categories"&&n.append("category",s),(await m.get(`${B}?${n}&${A(c)}`)).data}async function W(){return(await m.get("https://food-boutique.b.goit.study/api/products/discount")).data}async function N(){return(await m.get("https://food-boutique.b.goit.study/api/products/popular")).data}async function C(t){let e,{keyword:s,category:a,page:o=1,limit:c,filterSearch:r}=t;const n=window.innerWidth;n<768?c=6:n>=768&&n<1440?c=8:c=9;const i=new URLSearchParams({limit:c,page:o});return s!==""&&i.append("keyword",s),a!==""&&a!=="Show_all"&&a!=="Categories"&&i.append("category",a),e=await m.get(`${B}?${i}&${A(r)}`),e.data}async function $(t){return(await m.get(`https://food-boutique.b.goit.study/api/products/${t}`)).data}function V(t){let{img:e,name:s,category:a,size:o,popularity:c,price:r,_id:n,is10PercentOff:i}=t;const l=d.some(p=>p.id===n);return`
      ...
      `}function U(t){const{img:e,name:s,category:a,size:o,popularity:c,_id:r}=t,n=d.some(i=>i.id===r);return`
        <li class="popular-product-card">
            <div class="poppular-img-wrapper">
              ...
              />
                ...
                <button data-id=${r} type="submit" class="popular-card-btn js-addToCart-btn" ${n?"disabled":""}>
  ...
  </li>`}function f(t,e,s){let a;e==="general"?a=t.map(o=>V(o)):e==="popular"?a=t.map(o=>U(o)):a=t.map(o=>J(o)),s.innerHTML=a.join("")}function q(){const t=document.querySelector(".modal-product-backdrop");t.remove(),t.classList.add("is-hidden"),document.body.classList.remove("is-overflow-hidden")}function Q(t){const e=document.querySelector(".modal-product-backdrop");t.key==="Escape"&&(q(),e.classList.add("is-hidden"))}function G(t){const e=document.querySelector(".modal-product-backdrop");t.target===e&&(q(),e.classList.remove("is-hidden"))}function Z(t){let{name:e,category:s,desc:a,img:o,price:c,size:r,popularity:n,_id:i}=t;const l=d.some(p=>p.id===i);return`
      ...
      `}async function h(t){if(t.target.closest(".js-addToCart-btn"))return;const a=t.target.closest("li").querySelector(".js-addToCart-btn").getAttribute("data-id"),o=await $(a);document.querySelector("body").insertAdjacentHTML("beforeend",Z(o)),document.body.classList.add("is-overflow-hidden"),document.querySelector(".modal-btn-close").addEventListener("click",q),document.addEventListener("keydown",Q),document.addEventListener("click",G),document.querySelector(".modal-product-btn-price").addEventListener("click",ct)}async function k(t){const e=t.currentTarget.getAttribute("data-id");t.currentTarget.querySelector("use").setAttribute("href",`${u}#checkmark`),t.currentTarget.setAttribute("disabled","true");const a={};try{const c=await $(e);console.log(c);const{category:r,size:n,_id:i,name:l,price:p,img:y}=c;a.category=r,a.size=n,a.id=i,a.name=l,a.price=p,a.img=y}catch(c){console.log(c)}const o=window.localStorage;d.push(a),o.setItem("product",JSON.stringify(d)),w()}function M(){return`
