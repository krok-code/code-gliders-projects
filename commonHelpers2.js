import"./assets/header-06e5e9ac.js";import{a as e}from"./assets/vendor-a61d8330.js";const n="https://food-boutique.b.goit.study/api/products",c=()=>{const t={limit:5};return e(`${n}/popular`,{params:t})},i=()=>e(`${n}/discount`),a={popular:document.querySelector(".popular_list"),discount:document.querySelector(".discount_list")};document.addEventListener("DOMContentLoaded",o);document.addEventListener("DOMContentLoaded",d);async function o(){try{const{data:t}=await c();a.popular.insertAdjacentHTML("beforeend",r(t)),console.log(t)}catch(t){console.log(t)}}function r(t){return t.map(s=>` <li class="card_item">
      <div class="card_img">
        <img
          src=${s.img}
          width="56"
